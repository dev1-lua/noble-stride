...
// Note: no DIGESTS_COLLECTION here — stored weekly digests live on
// summarizerAgent, and Lua Data collections are agent-scoped. weekOf is kept:
// the followup-check job uses it to dedupe flags per ISO week.
