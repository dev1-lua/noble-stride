...
export class ListGreylistedInvestorsTool implements LuaTool {
  ...
  description =
    "List investors currently classified Greylisted (optionally also Excluded). Internal read-only reference: returns each investor's name, classification, type, and CRM deep link, never raw record ids. Use when staff ask which investors are greylisted or excluded (e.g. 'who's greylisted?', 'show the greylisted funds').";
