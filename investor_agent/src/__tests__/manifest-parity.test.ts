...
// 2026-07-21 QA (deploy-drift): prod was running guard processors that the committed
// manifest didn't declare, so anyone reasoning about prod from the manifest mis-diagnosed
// the security posture. This pins manifest ↔ code parity: every processor registered in
