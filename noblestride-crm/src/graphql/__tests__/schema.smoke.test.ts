...
describe("graphql schema", () => {
  it("builds without errors and exposes a query type with 42 queries and 80 mutations", async () => {
    ...
    expect(mutationFields).toHaveLength(80);
    ...
    expect(queryFields).toContain("outreachDrafts");
