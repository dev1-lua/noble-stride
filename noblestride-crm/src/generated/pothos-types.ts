...
export default interface PrismaTypes {
    ...
    Person: {
        ...
        Create: {};
        Update: {};
        RelationName: "investor" | "client" | "partner" | "ssaForInvestors" | "authAccount";
