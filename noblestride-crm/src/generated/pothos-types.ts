/* eslint-disable */
import type { Prisma, User, Person, Investor, Client, Mandate, Transaction, Engagement, Partner, Activity, Task } from "/Users/devashishthapliyal/Documents/work/Lua/NOBLESTRIDE/noblestride-crm/node_modules/.pnpm/@prisma+client@6.19.3_prisma@6.19.3_typescript@5.9.3__typescript@5.9.3/node_modules/@prisma/client/index.js";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "ledMandates" | "ownedTransactions" | "ownedEngagements" | "activities" | "assignedTasks";
        ListRelations: "ledMandates" | "ownedTransactions" | "ownedEngagements" | "activities" | "assignedTasks";
        Relations: {
            ledMandates: {
                Shape: Mandate[];
                Name: "Mandate";
    ...
    Person: {
        ...
        Create: {};
        Update: {};
        RelationName: "investor" | "client" | "partner";
        ListRelations: never;
        Relations: {
            investor: {
                Shape: Investor | null;
    ...
    Investor: {
        ...
        Create: {};
        Update: {};
        RelationName: "contacts" | "engagements" | "activities" | "tasks";
        ListRelations: "contacts" | "engagements" | "activities" | "tasks";
        Relations: {
            contacts: {
                Shape: Person[];
                Name: "Person";
    ...
    Client: {
        ...
        Create: {};
        Update: {};
        RelationName: "contacts" | "mandates" | "transactions" | "tasks";
        ListRelations: "contacts" | "mandates" | "transactions" | "tasks";
        Relations: {
            contacts: {
                Shape: Person[];
                Name: "Person";
    ...
    Transaction: {
        ...
        Create: {};
        Update: {};
        RelationName: "client" | "mandate" | "owner" | "engagements" | "activities" | "tasks";
        ListRelations: "engagements" | "activities" | "tasks";
        Relations: {
            client: {
                Shape: Client;
                Name: "Client";
