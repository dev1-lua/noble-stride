/* eslint-disable */
import type { Prisma, User, Person, Investor, Client, Mandate, Transaction, Engagement, EngagementMilestone, Partner, Activity, Task, ServiceProvider, Document, StageChange } from "D:\\LuaWork\\NobleStride\\noble-stride\\noblestride-crm\\node_modules\\.pnpm\\@prisma+client@6.19.3_prism_1d040ab5215f59f0e27ddee7f0cf082e\\node_modules\\@prisma\\client/index.js";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "ledMandates" | "ownedTransactions" | "ownedEngagements" | "activities" | "assignedTasks" | "documents" | "reviewedDocuments" | "approvedDocuments" | "assistantTransactions" | "assistantTasks" | "stageChanges";
        ListRelations: "ledMandates" | "ownedTransactions" | "ownedEngagements" | "activities" | "assignedTasks" | "documents" | "reviewedDocuments" | "approvedDocuments" | "assistantTransactions" | "assistantTasks" | "stageChanges";
        Relations: {
            ledMandates: {
                Shape: Mandate[];
                Name: "Mandate";
    ...
    Investor: {
        ...
        Create: {};
        Update: {};
        RelationName: "ssaRegionContact" | "contacts" | "engagements" | "activities" | "tasks" | "documents" | "stageChanges";
        ListRelations: "contacts" | "engagements" | "activities" | "tasks" | "documents" | "stageChanges";
        Relations: {
            ssaRegionContact: {
                Shape: Person | null;
                Name: "Person";
    ...
    Mandate: {
        ...
        Create: {};
        Update: {};
        RelationName: "client" | "lead" | "referredBy" | "transactions" | "activities" | "tasks" | "stageChanges";
        ListRelations: "transactions" | "activities" | "tasks" | "stageChanges";
        Relations: {
            client: {
                Shape: Client;
                Name: "Client";
    ...
    Transaction: {
        ...
        Create: {};
        Update: {};
        RelationName: "client" | "mandate" | "owner" | "assistant" | "engagements" | "activities" | "tasks" | "serviceProviders" | "documents" | "stageChanges";
        ListRelations: "engagements" | "activities" | "tasks" | "serviceProviders" | "documents" | "stageChanges";
        Relations: {
            client: {
                Shape: Client;
                Name: "Client";
    ...
    Partner: {
        ...
        Create: {};
        Update: {};
        RelationName: "contacts" | "referredMandates" | "stageChanges";
        ListRelations: "contacts" | "referredMandates" | "stageChanges";
        Relations: {
            contacts: {
                Shape: Person[];
                Name: "Person";
    ...
    Document: {
        ...
        Create: {};
        Update: {};
        RelationName: "uploadedBy" | "reviewer" | "approver" | "transaction" | "client" | "investor";
        ListRelations: never;
        Relations: {
            uploadedBy: {
                Shape: User | null;
