...
export default interface PrismaTypes {
    ...
    Transaction: {
        ...
        Create: {};
        Update: {};
        RelationName: "client" | "mandate" | "owner" | "assistant" | "referredBy" | "engagements" | "activities" | "tasks" | "serviceProviders" | "documents" | "stageChanges";
    ...
    Partner: {
        ...
        Create: {};
        Update: {};
        RelationName: "contacts" | "referredMandates" | "referredTransactions" | "stageChanges";
        ListRelations: "contacts" | "referredMandates" | "referredTransactions" | "stageChanges";
        Relations: {
            contacts: {
                Shape: Person[];
                Name: "Person";
    ...
    Document: {
        ...
        Create: {};
        Update: {};
        RelationName: "uploadedBy" | "reviewer" | "approver" | "transaction" | "client" | "investor" | "mandate";
        ListRelations: never;
        Relations: {
            uploadedBy: {
                Shape: User | null;
