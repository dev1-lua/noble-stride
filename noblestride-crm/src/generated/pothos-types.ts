...
export default interface PrismaTypes {
    ...
    Client: {
        ...
        Create: {};
        Update: {};
        RelationName: "contacts" | "mandates" | "transactions" | "tasks" | "documents" | "activities";
        ListRelations: "contacts" | "mandates" | "transactions" | "tasks" | "documents" | "activities";
        Relations: {
            contacts: {
                Shape: Person[];
                Name: "Person";
    ...
    StageChange: {
        ...
        Create: {};
        Update: {};
        RelationName: "changedBy" | "mandate" | "transaction" | "engagement";
        ListRelations: never;
        Relations: {
            changedBy: {
                Shape: User | null;
