/* eslint-disable */
import type { Prisma, User, Person, Investor, Client, Mandate, Transaction, Engagement, EngagementMilestone, DueDiligenceTrack, Partner, Activity, Task, ServiceProvider, Document } from "D:\\LuaWork\\NobleStride\\noble-stride\\noblestride-crm\\node_modules\\.pnpm\\@prisma+client@6.19.3_prism_1d040ab5215f59f0e27ddee7f0cf082e\\node_modules\\@prisma\\client/index.js";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "ledMandates" | "ownedTransactions" | "ownedEngagements" | "ddTracks" | "activities" | "assignedTasks" | "documents" | "reviewedDocuments" | "approvedDocuments";
        ListRelations: "ledMandates" | "ownedTransactions" | "ownedEngagements" | "ddTracks" | "activities" | "assignedTasks" | "documents" | "reviewedDocuments" | "approvedDocuments";
        Relations: {
            ledMandates: {
                Shape: Mandate[];
                Name: "Mandate";
    ...
    Transaction: {
        ...
        Create: {};
        Update: {};
        RelationName: "client" | "mandate" | "owner" | "engagements" | "activities" | "tasks" | "serviceProviders" | "documents" | "ddTracks";
        ListRelations: "engagements" | "activities" | "tasks" | "serviceProviders" | "documents" | "ddTracks";
        Relations: {
            client: {
                Shape: Client;
                Name: "Client";
    ...
    Engagement: {
        ...
        Create: {};
        Update: {};
        RelationName: "transaction" | "investor" | "owner" | "activities" | "milestones";
        ListRelations: "activities" | "milestones";
        Relations: {
            transaction: {
                Shape: Transaction;
                Name: "Transaction";
